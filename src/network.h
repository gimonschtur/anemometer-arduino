...
void httpRequestPOST(String id_num, String data1, String data2, String data3, String data4, String add) {
  ...
  jsonString += id_num;
  jsonString += "\",\"windSpeed\":\"";
  jsonString += data1;
  jsonString += "\",\"RSSI\":\"";
  jsonString += data2;
  jsonString += "\",\"battLevel\":\"";
  jsonString += data3;
  jsonString += "\",\"battVoltage\":\"";
  jsonString += data4;
  jsonString += "\"}";
